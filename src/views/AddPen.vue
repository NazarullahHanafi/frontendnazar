    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form v-on:submit.prevent="dataDiri">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control" required name="email"  id="nama" v-model="penduduk.nama" aria-describedby="helpId" placeholder="">
...
export default {
    ...
    methods:{
        dataDiri(){
            ...
            fetch('https://nazarullah.000webhostapp.com/index.php/?tambah',{
                method:"POST",
